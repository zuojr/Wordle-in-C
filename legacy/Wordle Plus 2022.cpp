...
int main(){
	...
	//Play background music
	playMusic();
	//Choose game modesingleplayer or doubleplayer)
	int l = modeChooser();
	if(l < 0){
		return EXIT_SUCCESS;
	}
...
void playMusic(){
	//!!!preconditionin Dev-C++ToolsCompiler OptionsGenerallinker-calleradd ' -lwinmm'(a space is neended before -lwinmm) )
